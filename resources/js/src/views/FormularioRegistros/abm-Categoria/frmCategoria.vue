    ...
    <section>
        <b-card border-variant="info">
            <b-row>
                <b-col md="6">
                    <b-form-group>
                        <label class="d-inline d-lg-flex">Nombre de la Categoria</label>
                        <b-form-input v-model="catNombre" :state="catNombre.length ? true : false" required />
                    </b-form-group>
                </b-col>
...
export default {
    ...
    methods: {
        ...
        TraerCategoria() {
            ...
            var url = "api/auth/TraerCategoria";
            me.loaded = false;
            var lista = [];
            axios
                .post(url, params)
        ...
        Guardar() {
            ...
            me.items = [];
            var urlm = "api/auth/agregarCategoria";
            me.loaded = false;
            me.isBusy = true;
            formData.append("txt_catNombre", me.catNombre);
        ...
        modificar() {
            ...
            me.items = [];
            var urlm = "api/auth/modificarCategoria";
            me.loaded = false;
            me.isBusy = true;
