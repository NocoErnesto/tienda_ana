    ...
    <section>
        <b-card border-variant="info">
            <b-row>
                <b-col md="6">
                    <b-form-group>
                        <label class="d-inline d-lg-flex">Nombre de la Caja</label>
                        <b-form-input v-model="cajNombre" :state="cajNombre.length ? true : false" required />
                    </b-form-group>
                </b-col>
...
export default {
    ...
    methods: {
        ...
        Guardar() {
            ...
            me.items = [];
            var urlm = "api/auth/CrearCaja";
            me.loaded = false;
            me.isBusy = true;
            formData.append("txt_cajNombre", me.cajNombre);
