...
<template>
  <section>
    ...
    <div>
      <b-modal ref="frm-caja" id="frm-caja" ok-title="Cerrar" ok-variant="danger" ok-only size="lg" centered
        title="Registro de Caja" @ok="ListadoCaja">
          ...
          <!-- <b-card-body> -->
            <b-row>
              <b-col sm="4" md="5" xl="6" lg="6" class="mb-1">
                <!-- Boton Modal -->
                <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" v-b-modal.frm-caja variant="success"
            ...
            <b-row>
              <b-col>
                <!-- Tabla --> <!-- Listado -->
                <b-table id="tabla-lista-retrasos" :items="items" :fields="fields" :filter="filter" @filtered="onFiltered"
...
import FrmCaja from './frmCaja.vue';
export default {
  components: {
    VBTooltip,
    vSelect,
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "cajNombre", label: "NOMBRE", sortable: true },
