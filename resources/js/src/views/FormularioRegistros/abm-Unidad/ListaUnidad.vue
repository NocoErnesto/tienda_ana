...
<template>
  <section>
    ...
    <div>
      <b-modal ref="frmUnidades" id="frmUnidades" ok-title="Cerrar" ok-variant="danger" ok-only size="lg" centered
        title="Registro de Unidades" @ok="listarUnidades">
        ...
        <b-card border-variant="info">
          ...
          <b-row>
            <b-col sm="4" md="5" xl="6" lg="6" class="mb-1">
              <!-- Boton Modal -->
              <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" v-b-modal.frmUnidades variant="success"
          ...
          <b-row>
            <b-col>
              <!-- Tabla --> <!-- Listado -->
              <b-table id="tabla-lista-unidades" :items="items" :fields="fields" :filter="filter" @filtered="onFiltered"
...
import frmUnidades from "./frmUnidades.vue";
...
export default {
  ...
  methods: {
    ...
    eliminar(item) {
      ...
      var url = "api/auth/eliminarUnidad";
      me.isBusy = true;
      axios
        .post(url, params)
    ...
    listarUnidades() {
      ...
      me.items = [];
      me.isBusy = true;
      var url = "api/auth/listarUnidades";
      me.loaded = false;
      var lista = [];
      axios
        .get(url)
