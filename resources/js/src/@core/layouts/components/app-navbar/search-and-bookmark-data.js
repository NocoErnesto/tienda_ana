...
export default {
  ...
  pages: {
    key: 'title',
    data: [
      // { title: 'Headcount', route: { name: 'Dashboard' }, icon: 'UserIcon', isBookmarked: true },
      // { title: 'Tiempos', route: { name: 'HorasExtras' }, icon: 'ClockIcon', isBookmarked: true },
      // { title: 'Remuneraciones', route: { name: 'Remuneraciones' }, icon: 'DollarSignIcon', isBookmarked: true },
      // { title: 'Desarrollo', route: { name: 'desarrollo' }, icon: 'BarChart2Icon', isBookmarked: true },
      // { title: 'Importacion', route: { name: 'Importacion' }, icon: 'DownloadCloudIcon', isBookmarked: true },
      // { title: 'Formularios ABM', route: { name: 'Registro' }, icon: 'ListIcon', isBookmarked: true },
      // { title: 'Canvas R&R', route: { name: 'ListadoGeneral' }, icon: 'FileTextIcon', isBookmarked: true},
      // { title: 'Matriz', route: { name: 'atcMatriz' }, icon: 'GridIcon', isBookmarked: false}, 
